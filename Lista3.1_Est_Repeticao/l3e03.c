...
// Desenvolva um algoritmo que leia um número indeterminado de valores e calcule a média
// aritmética, a quantidade de valores positivos e negativos, além do percentual de valores
